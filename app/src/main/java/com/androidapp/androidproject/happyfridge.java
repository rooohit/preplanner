...
public class happyfridge extends AppCompatActivity {
    Button button;
    TextView textView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_happyfridge);
    ...
    public void event2(View view){
        ...
        textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setData(Uri.parse("mailto:contact@thehappyfridge.com"));
                String[] to={" "};
